...
\noindent Suppose no path exists from $t_0$ to $t_1$. Since $G$ is weakly triangulated there exists $p_i\in P$ and
$q_j\in Q$ with an
edge $p_iq_m\in E(G)$. We may then separately apply the inductive hypothesis to the subgraph bounded by
...
of the paths. To find $t_0$ we look at the ordered neighbors of $p_0$ and take the vertex counterclockwise past
$q_0$. We find $t_1$ similarly by looking at $p_n$ and $q_m$.\\
...
Let $x,y\in C$ be not necessarily distinct, potentially precolored vertices. Let $p\in C[x,y]$ be precolored some
