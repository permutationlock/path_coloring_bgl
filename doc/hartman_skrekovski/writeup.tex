...
\begin{tikzpicture}[
		scale=1,
		every node/.style={circle, draw, minimum size=1mm, scale=0.8},
...
\begin{tikzpicture}[
  ...
  \node (q0) [label=below:$q_0$, fill] at (-2cm, -1cm) {};
  \node (qn) [label=below:$q_m$, fill] at (2cm, -1cm) {};
  \node (t0) [label=left:$u$, fill] at (-1cm, 0cm) {};
  \node (t1) [label=above:$t_1$, fill] at (1cm, 0cm) {};
...
\begin{tikzpicture}[
  ...
  \node (c_n) [label=above:$c_n$, fill] at (-1.5cm, 1.25cm) {};
  \node (p) [label=above:$p$, fill] at (0cm, 2cm) {};
...
\begin{tikzpicture}[
  ...
  \node (c_n) [label=above:$c_n$, fill] at (-1.5cm, 1.25cm) {};
  \node (p) [label=above:{$x,y,p$}, fill] at (0cm, 2cm) {};
  \node (c_1) [label=above:$c_1$, fill] at (1.5cm, 1.25cm) {};
  \node (c_i) [label=below:$c_i$, fill] at (0cm, -1cm) {};
  \node (G_0) [draw=none, ] at (-0.75cm, 0.12cm) {$G_0$};
  \node (G_1) [draw=none] at (0.7cm, 0.5cm) {$G_1$};
...
\begin{tikzpicture}[
  ...
  \node (c_n) [label=above:{$x_0,p_0$}, fill] at (-1.5cm, 1.25cm) {};
...
\begin{tikzpicture}[
  ...
  \node (p) [label=above:{$y_1,p_1$}, fill] at (0cm, 2cm) {};
  \node (c_1) [label=above:$c_1$, fill] at (1.5cm, 1.25cm) {};
...
\begin{tikzpicture}[
  ...
  \node (c_n) [label=above:$c_n$, fill] at (-1.5cm, 1.25cm) {};
  \node (p) [label=above:{$y$, $p$}, fill] at (0cm, 2cm) {};
  \node (x) [label=below right:$x$, fill] at (1.5cm, 0.5cm) {};
  \node (c_i) [label=below:$c_i$, fill] at (0cm, -1cm) {};
  \node (G_0) [draw=none, ] at (-0.75cm, 0.12cm) {$G_0$};
  \node (G_1) [draw=none] at (0.7cm, 0.5cm) {$G_1$};
  \node (null) [draw=none] at (270:1.5cm) {};
...
\begin{tikzpicture}[
  ...
  \node (c_n) [label=above:{}, fill] at (-1.5cm, 1.25cm) {};
  \node (c_i) [label=below:{$x_0$, $y_0$, $p_0$}, fill] at (0cm, -1cm) {};
  \node (G_0) [draw=none] at (-0.75cm, 0.12cm) {$G_0$};
  \node (null) [draw=none] at (270:1.5cm) {};
  \draw (c_i) edge [bend left] (c_n) [dashed];
  \draw (c_n) edge [bend left] (c_i) [dashed];
...
\begin{tikzpicture}[
  ...
  \node (p) [label=above:{$y_1$, $p_1$}, fill] at (0cm, 2cm) {};
  \node (x) [label=below right:$x_1$, fill] at (1.5cm, 0.5cm) {};
  \node (c_i) [label=below:$c_i$, fill] at (0cm, -1cm) {};
  \node (G_1) [draw=none] at (0.7cm, 0.5cm) {$G_1$};
  \node (null) [draw=none] at (270:1.5cm) {};
  \draw (p) edge (c_i);
