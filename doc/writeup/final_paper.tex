...
a path $3$-coloring of $G$ such that no vertex in $G-C$ recieves the same color
...
$(s_1,s_2)=\text{Nbr}[v_{j_l}]$. Let $r_v$ be the reference to the node for
...
$(s_1,s_2)=\text{Nbr}[v]$. Let $r_v$ be the reference to the node for
$v$ in $\text{Adj}[u]$ and $s_u$ be the reference to the node for $u$ in
$\text{Adj}[v]$.
