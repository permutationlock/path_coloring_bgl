...
In some graph drawings in this project, such as Figure \ref{poh_figure}, a
dashed line between a pair of vertices $u,v$ will denote a $uv$-path.
...
\caption{Hartman-Skrekovski case 1.1 (left) and case 1.2 (right).}
\end{center}
\end{figure}
...
runs in linear time.
Finally, we provided a docmented implementation of each algorithm in C++.
