...
counterclockwise by a neighbor $v_i\in P$.
...
We may then apply \textit{Path Trace} (4.4) to color the chordless cycle
$C_y=v_iv_{i+1}\ldots v_jt_p$, with the vertex $y$ forming the face $yt_pv_i$.
...
We may finally apply \text{Remove Path} (5.2) to the cycle formed by $P$ and
