...
\begin{tikzpicture}
  \node (c_n) [label=above left:$v_k$, fill] at (-1.5cm, 1.25cm) {};
  \node (p) [label=above:{$v_1$}] at (0cm, 2cm) {};
  \node (y) [label=right:$y$] at (1.5cm, 1.25cm) {};
  \node (x) [label=right:$x$] at (1.5cm, -0.25cm) {};
  \node (c_i) [label=below:$u$] at (0cm, -1cm) {};
  \node (G_0) [draw=none, fill=none] at (-0.75cm, 0.12cm) {$C_1$};
  \node (G_1) [draw=none, fill=none] at (0.7cm, 0.5cm) {$C_2$};
...
$u$. We will apply \textit{Remove Path} (5.4) to remove the single colored
vertex $n$, with the vertices immediately adjacent to $n$ on $C_1$ as the fixed
vertices. This ensures $n$ recieves no same color neighbors in
$\text{Int}(C_1)$. 
...
\begin{tikzpicture}
  \node (c_n) [label=above left:{$v_k$}, fill] at (-1.5cm, 1.25cm) {};
  \node (x) [label=below left:{$x$}] at (-1.5cm, 0.25cm) {};
  \node (c_i) [label=below:{$u$}, fill] at (0cm, -1cm) {};
  \node (G_0) [draw=none,fill=none] at (-0.75cm, 0.12cm) {$C_1$};
  \node (null) [draw=none,fill=none] at (270:1.5cm) {};
  \draw (c_i) edge (x) [dashed];
...
vertex $u$. This ensures $u$ recieves no same color neighbors in
$\text{Int}(C_2)$.
...
\begin{tikzpicture}
  \node (c_n) [label=above left:{$v_k$}, fill] at (-1.5cm, 1.25cm) {};
  \node (x) [label=left:{$x$}] at (-1.5cm, 0.25cm) {};
  \node (y) [label=below left:$y$, fill] at (-1cm, -0.75cm) {};
  \node (c_i) [label=below:$u$, fill] at (0cm, -1cm) {};
  \node (G_0) [draw=none,fill=none] at (-0.75cm, 0.05cm) {$C_1$};
  \node (null) [draw=none,fill=none] at (270:1.5cm) {};
